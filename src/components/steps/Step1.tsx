...
export const Step1 = ({ onNext }: Step1Props) => {
  ...
  return (
    <div className="step-card text-center max-w-md mx-auto slide-up-enter">
      <h2
        className={`text-3xl font-bold mb-4 text-foreground transition-all duration-300 ${
      ...
      <p
        className={`text-lg text-muted-foreground leading-relaxed transition-all duration-300 ${
          !isRunning ? "opacity-100 max-h-[1000px] mb-8" : "opacity-0 h-0"
        }`}
      >
